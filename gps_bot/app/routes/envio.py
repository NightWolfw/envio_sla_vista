...
@bp.route('/')
def rapido():
    # Busca valores únicos para filtros
    filtros_valores = obter_valores_unicos_filtros(apenas_ativos=True)

    # Busca apenas grupos com envio ativo
    grupos = listar_grupos()
    grupos_ativos = [g for g in grupos if g[3]]  # g[3] = coluna 'envio'

    return render_template('envio/rapido.html',
